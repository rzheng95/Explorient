...
public class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		JButton btnContactListGenerator = new JButton("Contact List Generator");
		btnContactListGenerator.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				dispose();
				OperatingContactList s = new OperatingContactList();
			}
		});
		contentPane.add(btnContactListGenerator);
	}
